...
const Freetest = () => {
    ...
    const handleNextStep = (e) => {
        ...
        // console.log(topics.filter((item) => item?.isChecked !== true).length,"000000000000")
        //topics.filter((item) => item?.isChecked !== true).length > 1

        // if (
        //   topics.length <= 0 ||
        //   topics.filter((item) => item?.isChecked !== true).length == topics.length
        // ) {
        //   toast.error("Please select any topics..!");
        //   setLoader(false);
        // } else {
        setTimeout(() => {
            setLoader(false);
                                        ...
                                        <div className="form-group">
                                            <div className="radio-btn-page">
                                                <label className="cs-radio">
                                                    ...
                                                    <input
                                                        type="radio"
                                                        checked={testData.type == 2 ? "checked" : ""}
                                                        name="type"
                                                        value={2}
                                                        onChange={handleChange}
                                        ...
                                        <div className="form-group">
                                            <div className="radio-btn-page">
                                                <label className="cs-radio">
                                                    ...
                                                    <input
                                                        type="radio"
                                                        checked={testData.type == 3 ? "checked" : ""}
                                                        name="type"
                                                        value={3}
                                                        onChange={handleChange}
                                                        onClick={() => toggleShow(false)}
                ...
                return (
                    <>
                        <div className="free-testing-tabs">
                            ...
                            {isAuth && usersubscription && !flagchecked && (
                                <div className="free-testing-tabs">
                                    <ul>
                                        <li>
                                            <Switch
                            ...
                            <div className="row">
                                ...
                                {isAuth ? (
                                    <>
                                        <div className={show ? "col-md-6" : "col"}>
                                            <button
