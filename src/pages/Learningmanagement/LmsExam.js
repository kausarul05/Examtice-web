...
const ResumeSavedTest = () => {
    ...
    const saveTestTime = async (time) => {
        try {
            ...
            const {
                data: { status, message },
            } = await axios.post(SAVE_LMS_TIME, { exam_id: examId, spentTime: time, user_id: userId.id });
                                  ...
                                  Notes
                                   ...
                                   <MathJax.Provider>
                                    <MathJax.Html html={item.question} style={{color:'#fff'}}/>
                                                                ...
                                                                <ul>
                                                                    <button
                                                                        className={`${item.isAttempt && item.userOption == 1
                                                                            ? "exam"
                                                                            : ""
                                                                            }`}
                                                                    ...
                                                                    <button
                                                                        className={`${item.isAttempt && item.userOption == 2
                                                                            ? "exam"
                                                                            : ""
                                                                            }`}
                                                                    ...
                                                                    <button
                                                                        className={`${item.isAttempt && item.userOption == 3
                                                                            ? "exam"
                                                                            : ""
                                                                            }`}
                                                                    ...
                                                                    <button
                                                                        className={`${item.isAttempt && item.userOption == 4
                                                                            ? "exam"
                                                                            : ""
                                                                            }`}
                            ...
                            <div className="modal-body">
                                <div className="payment-sucess">
                                    ...
                                    <div className="edit-profile-modal__inner">
                                        <h4 className="theme-txt text-center mb-4 ">Flag Question</h4>
                                        <img src="assets/images/warning.png" alt="" />
                                        <form>
