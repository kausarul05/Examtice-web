...
const Question = ({ questions }) => {
    ...
    const handleUserBookmark = async (e) => {
        e.preventDefault();
    ...
    const handleUserUnBookmark = async (e, QuestionId) => {
        e.preventDefault();
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-7 col-md-7 quesnumber-box timer">
                                    ...
                                    <h5>
                                        ...
                                        {isAuth && item.isbookmark == false && !isExam ? <i className="fas fa-bookmark fa-sm question-bookmark-mobile-view" onClick={(e) => handleBookmark(item.id)}></i> : isAuth && item.isbookmark == true ? <i className="fas fa-bookmark fa-sm flaged-icon question-bookmark-mobile-view" onClick={(e) => handleUserUnBookmark(e, item.id)} title="Already bookmarked this question"></i> : ''}
                                        {/* <i className="fas fa-bookmark fa-sm" onClick={(e) => handleFlag(item.id)}></i> */}
                                        
                                        {isAuth && item.isFlag == false && !isExam ? <i className="fas fa-flag fa-sm question-bookmark-mobile-view" onClick={(e) => handleFlag(item.id)}></i> : isAuth && item.isFlag == true ? <i className="fas fa-flag fa-sm flaged-icon mobile-view-question-flag" onClick={(e) => handleUserUnFlagTest(e, item.id)} title="Already flagged this question"></i> : ''}
                                    </h5>
                                </div>
                    ...
                    <div className="modal-content">
                        <div className="modal-body">
                            <div className="payment-sucess">
                                ...
                                <div className="row">
                                    <a href="#" onClick={(e) => handleUserBookmark(e)}>
                                        Yes
                                    </a>
                                    <a
                                        href="#"
